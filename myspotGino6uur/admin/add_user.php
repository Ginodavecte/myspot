...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $add_usertype = mysqli_real_escape_string($connection, $_POST['usertype']);
        ...
        if($result->num_rows < 1){
            ...
            $sql = "INSERT INTO users (name, usertype, telefoon, email, points, username, password)
                    VALUES ('$add_name', '$add_usertype', '$add_telefoon','$add_email', 0 ,'$add_username','$passEncrypted');";
...
?>
    ...
    <table>
        ...
        <tr><td>Usertype : </td><td><input type="number" name="usertype" value="2" required>* </td></tr>
        ...
        <tr><td><a href="home.php">Ga terug naar home</a> </td><td><input type="submit" name="submitAddUser" value="Voeg Toe!"></td></tr>
